...
#' @param convert_rich_text_options Additional arguments to pass to the convert_rich_text function
#' @param postprocess_xml The function applied to the generated XML
#' @param postprocess_xml_options Additional arguments for postprocess_xml
#' conversion.

...
Typically you will build many questions on your computer, group them into pools or full tests, and then export these as Blackboard-ready ZIP files. See Blackboard's [question pool documentation](https://help.blackboard.com/Learn/Instructor/Tests_Pools_Surveys/Question_Pools) and [test documentation](https://help.blackboard.com/Learn/Instructor/Tests_Pools_Surveys/Tests) for how these imports are used in the LMS.
